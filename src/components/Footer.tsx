        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              {personalInfo.title} helping businesses turn ideas into reliable, scalable digital products.
            </p>
          </div>
          </Reveal>
        ...
        <Reveal>
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-300 font-medium mb-2">
              Open for freelance projects & collaboration — let&rsquo;s build something together.
            </p>
